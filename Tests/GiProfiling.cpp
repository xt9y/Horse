...
int main()
{
    ...
    const Renderer::Transform root_before = *root_transform;
    ...
    root_transform->matrix_override_enabled = false;
    root_transform->position.x = root_before.position.x + 3.0f;
