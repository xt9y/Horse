...
int main()
{
    ...
    const char *gl_write = std::strstr(
        gl,
    ...
    const char *metal_write = std::strstr(
        metal,
    ...
    assert(std::strstr(metal, "Hit depth_hit = traceClosest(") != nullptr);
